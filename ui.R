        ...
        sidebarLayout(
          sidebarPanel(
            ...
            tags$div(
              ...
              br(),
              actionButton("A", span("A", style = "color: #dc143c;")),
              actionButton("B", span("B", style = "color: #4169e1;")),
              actionButton("H", span("H", style = "color: #3cb371;")),
              actionButton("NA_", span("N/A", style = "color: #ffb6c1;")),
              actionButton("unknown", span("?", style = "color: #808080;")),
